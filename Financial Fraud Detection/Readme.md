...
How we can see in the figure, we have achieved to improve the metrics such as AUC (from 0.6915  to 0.7592 ), precision (from 0.0036 to 0.0048 ) and recall (from to 0.7353 ).
